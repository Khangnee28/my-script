-- ============================================================
-- KHANGLE DDS HUB — 4080 REMIX
-- menu chinh: sidebar + card (kieu anh mau, theme khac, dep hon)
-- nut noi: VUONG + LED RGB | tich hop OFFICE AUTOFARM
-- LOGIC GOC GIU NGUYEN: tuner / AutoT / dan ao / freecam / guide
-- ============================================================
...
local cornerAutoTFloat = Instance.new("UICorner", AutoTFloatingBtn)
cornerAutoTFloat.CornerRadius = UDim.new(0, 7)
...
local cornerBodyFloat = Instance.new("UICorner", BodyManagerFloatingBtn)
cornerBodyFloat.CornerRadius = UDim.new(0, 7)
...
local cornerFreecamFloat = Instance.new("UICorner", FreecamFloatingBtn)
cornerFreecamFloat.CornerRadius = UDim.new(0, 7)
...
-- ============ PAGE: TUNER ============
local tunerPage = pages["TUNER"] or addPage("TUNER")
...
local farmStatLbl = Instance.new("TextLabel")
...
-- cong tac switch
local function makeSwitch(par, posX, posY)
...
local farmSwitch = makeSwitch(farmCard, 0, 10)
...
local bodyOpenBtn = Instance.new("TextButton")
...
local fcOpenBtn = Instance.new("TextButton")
...
local guideOpenBtn = Instance.new("TextButton")
...
local cornerGuide = Instance.new("UICorner", GuideFrame)
...
-- ============ OFFICE FARM v20 (LOGIC GIU NGUYEN) ============
...
print("[hub remix] san sang — vuong miện mo menu, FARM bat bang cong tac")
