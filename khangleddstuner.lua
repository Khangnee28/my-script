...
local farmSwitch Lighting = game:GetService("Lighting")
...
local DRAG_KEYS  = { drag=true, dragcoefficient=true, airresistance=true, mass=true, weight=true, weightkg=true }
local seen = {}
local function tuneTable(t, depth)
    ...
    for k, v in pairs(t) do
        if type(k) == "string" then
            ...
            elseif RPM_KEYS[lk] and type(v) == "number" then
