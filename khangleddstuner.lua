...
-- v15: map-detect — map KHAC: cong tac farm XAM + bao "Chi hoat dong o Surakarta"
--      Surakarta: binh thuong, khong ghi gi
--      BO WaitForChild("Computers") => khong treo o map khac
